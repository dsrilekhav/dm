...
def main(_csv_fn,_target_col,_sensi_bound,_k,_accmeasure,_cut_point,_rez_fn):
    """
        ...
        :param _k: The number of clusters in the intermediate layer of neural network ranging from [1-10]
...
if __name__ == "__main__":
    # Choose from ["scoreDiff", "positionDiff", "kendallDis", "spearmanDis", "pearsonDis"] to measure accuracy
    main("./datasets/GermanCredit_Age35.csv",3,1,10,"positionDiff",10,"testOptimization.csv")
